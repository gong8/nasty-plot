...
import { getFormat, getFormatPokemon } from "@/modules/formats";
import type { PaginatedResponse, PokemonSpecies } from "@/shared/types";
...
export async function GET(
  ...
  if (!format) {
    return NextResponse.json(
      { error: "Format not found", code: "NOT_FOUND" },
      { status: 404 }
    );
  }

...
import type { BattleState, AIPlayer, BattleAction, BattleActionSet, BattleFormat } from "@nasty-plot/battle-engine";
...
function makeP1Request(opts: { teamPreview?: boolean; wait?: boolean; forceSwitch?: boolean } = {}): string {
  if (opts.wait) {
  ...
  if (opts.teamPreview) {
    return JSON.stringify({
      ...
      side: {
        ...
        name: "Player",
        pokemon: [
          { ident: "p1: Garchomp", details: "Garchomp, L100", condition: "319/319", active: false, stats: { atk: 394, def: 226, spa: 176, spd: 206, spe: 333 }, moves: ["earthquake"], baseAbility: "roughskin", item: "lifeorb", teraType: "Ground" },
        ],
      },
    });
  }
  if (opts.forceSwitch) {
    return JSON.stringify({
      ...
      side: {
        ...
        name: "Player",
        pokemon: [
          { ident: "p1a: Garchomp", details: "Garchomp, L100", condition: "0 fnt", active: true, stats: {}, moves: [] },
          { ident: "p1: Heatran", details: "Heatran, L100", condition: "311/311", active: false, stats: { atk: 194, def: 248, spa: 394, spd: 248, spe: 169 }, moves: ["magmastorm"], baseAbility: "flashfire", item: "leftovers" },
        ],
      },
    });
  }
  return JSON.stringify({
    ...
    side: {
      ...
      name: "Player",
      pokemon: [
        { ident: "p1a: Garchomp", details: "Garchomp, L100, M", condition: "319/319", active: true, stats: { atk: 394, def: 226, spa: 176, spd: 206, spe: 333 }, moves: ["earthquake", "dragonclaw"], baseAbility: "roughskin", item: "lifeorb", teraType: "Ground" },
        { ident: "p1: Heatran", details: "Heatran, L100", condition: "311/311", active: false, stats: { atk: 194, def: 248, spa: 394, spd: 248, spe: 169 }, moves: ["magmastorm"], baseAbility: "flashfire", item: "leftovers" },
      ],
    },
  });
...
function makeP2Request(opts: { teamPreview?: boolean; wait?: boolean; forceSwitch?: boolean } = {}): string {
  if (opts.wait) {
  ...
  if (opts.teamPreview) {
    return JSON.stringify({
      ...
      side: {
        ...
        name: "Opponent",
        pokemon: [
          { ident: "p2: Heatran", details: "Heatran, L100", condition: "311/311", active: false, stats: { atk: 194, def: 248, spa: 394, spd: 248, spe: 169 }, moves: ["magmastorm"], baseAbility: "flashfire", item: "leftovers" },
        ],
      },
    });
  }
  if (opts.forceSwitch) {
    return JSON.stringify({
      ...
      side: {
        ...
        name: "Opponent",
        pokemon: [
          { ident: "p2a: Heatran", details: "Heatran, L100", condition: "0 fnt", active: true, stats: {}, moves: [] },
          { ident: "p2: Clefable", details: "Clefable, L100", condition: "394/394", active: false, stats: { atk: 146, def: 186, spa: 226, spd: 216, spe: 156 }, moves: ["moonblast"], baseAbility: "magicguard", item: "leftovers" },
        ],
      },
    });
  }
  return JSON.stringify({
    ...
    side: {
      ...
      name: "Opponent",
      pokemon: [
        { ident: "p2a: Heatran", details: "Heatran, L100", condition: "311/311", active: true, stats: { atk: 194, def: 248, spa: 394, spd: 248, spe: 169 }, moves: ["magmastorm"], baseAbility: "flashfire", item: "leftovers" },
        { ident: "p2: Clefable", details: "Clefable, L100", condition: "394/394", active: false, stats: { atk: 146, def: 186, spa: 226, spd: 216, spe: 156 }, moves: ["moonblast"], baseAbility: "magicguard", item: "leftovers" },
      ],
    },
  });
...
describe("BattleManager", () => {
  ...
  describe("start", () => {
    it("writes start and player commands to the stream", async () => {
      ...
      expect(mockStreamWrite).toHaveBeenCalledWith(expect.stringContaining('>start {"formatid":"gen9ou"}'));
  ...
  describe("SetPredictor integration", () => {
    it("updates predictor when opponent moves are observed", async () => {
      ...
      expect(mockPredictor.updateFromObservation).toHaveBeenCalledWith(
        "heatran",

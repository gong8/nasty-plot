...
describe("calculateSynergy", () => {
    ...
    const diverseTeam = [
      makeSlot("garchomp", ["Dragon", "Ground"], {
        species: {
          ...
          abilities: { "0": "Rough Skin" }, weightkg: 95,
        },
      }),
      makeSlot("ferrothorn", ["Grass", "Steel"], {
        species: {
          id: "ferrothorn", name: "Ferrothorn", num: 598,
          types: ["Grass", "Steel"],
          baseStats: { hp: 74, atk: 94, def: 131, spa: 54, spd: 116, spe: 20 },
          abilities: { "0": "Iron Barbs" }, weightkg: 110,
        },
      }),
    ];
  ...
  it("rewards physical/special balance", () => {
    ...
    const balancedTeam = [
      ...
      makeSlot("heatran", ["Fire", "Steel"], {
        species: {
          id: "heatran", name: "Heatran", num: 485,
          types: ["Fire", "Steel"],
          baseStats: { hp: 91, atk: 90, def: 106, spa: 130, spd: 106, spe: 77 },
          abilities: { "0": "Flash Fire" }, weightkg: 430,
        },
      }),
    ];

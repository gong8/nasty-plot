...
describe("GreedyAI", () => {
  ...
  it("switches when best damage is very low (lines 70-72)", async () => {
    ...
    const actions: BattleActionSet = {
      moves: [
        { name: "Toxic", id: "toxic", pp: 16, maxPp: 16, type: "Poison", disabled: false, target: "normal", basePower: 0, category: "Status", accuracy: 90, description: "Badly poisons the target." },
        { name: "Protect", id: "protect", pp: 16, maxPp: 16, type: "Normal", disabled: false, target: "self", basePower: 0, category: "Status", accuracy: true, description: "Protects this turn." },
      ],
      canTera: true,
      switches: [
        { index: 2, name: "Clefable", speciesId: "clefable", hp: 394, maxHp: 394, status: "", fainted: false },
  ...
  it("uses fallbackMove when no moves found a best damage (lines 80-84)", async () => {
    ...
    const actions: BattleActionSet = {
      moves: [
        { name: "Toxic", id: "toxic", pp: 16, maxPp: 16, type: "Poison", disabled: true, target: "normal", basePower: 0, category: "Status", accuracy: 90, description: "" },
        { name: "Protect", id: "protect", pp: 16, maxPp: 16, type: "Normal", disabled: true, target: "self", basePower: 0, category: "Status", accuracy: true, description: "" },
      ],
      canTera: false,
      switches: [],
      forceSwitch: false,
...
describe("HeuristicAI", () => {
  ...
  it("falls back to move when no scored actions available", async () => {
    ...
    const actions: BattleActionSet = {
      moves: [
        { name: "Magma Storm", id: "magmastorm", pp: 8, maxPp: 8, type: "Fire", disabled: true, target: "normal", basePower: 100, category: "Special", accuracy: 75, description: "" },
      ],
      canTera: false,
      switches: [],
      forceSwitch: false,
  ...
  it("considers switching when matchup is unfavorable", async () => {
    ...
    const actions: BattleActionSet = {
      ...
      canTera: false,
      switches: [
        { index: 2, name: "Dragonite", speciesId: "dragonite", hp: 323, maxHp: 323, status: "", fainted: false },
      ],
      forceSwitch: false,
    };
  ...
  it("scores status moves correctly (toxic on unstatused opponent)", async () => {
    ...
    const actions: BattleActionSet = {
      moves: [
        { name: "Toxic", id: "toxic", pp: 16, maxPp: 16, type: "Poison", disabled: false, target: "normal", basePower: 0, category: "Status", accuracy: 90, description: "" },
        { name: "Protect", id: "protect", pp: 16, maxPp: 16, type: "Normal", disabled: false, target: "self", basePower: 0, category: "Status", accuracy: true, description: "" },
      ],
      canTera: false,
      switches: [],
      forceSwitch: false,
  ...
  it("scores hazard moves based on turn count", async () => {
    ...
    const actions: BattleActionSet = {
      moves: [
        { name: "Stealth Rock", id: "stealthrock", pp: 20, maxPp: 20, type: "Rock", disabled: false, target: "foeSide", basePower: 0, category: "Status", accuracy: true, description: "" },
        { name: "Tackle", id: "tackle", pp: 35, maxPp: 35, type: "Normal", disabled: false, target: "normal", basePower: 40, category: "Physical", accuracy: 100, description: "" },
      ],
      canTera: false,
      switches: [],
      forceSwitch: false,
  ...
  it("handles recovery moves when hp is low", async () => {
    ...
    const actions: BattleActionSet = {
      moves: [
        { name: "Recover", id: "recover", pp: 16, maxPp: 16, type: "Normal", disabled: false, target: "self", basePower: 0, category: "Status", accuracy: true, description: "" },
        { name: "Tackle", id: "tackle", pp: 35, maxPp: 35, type: "Normal", disabled: false, target: "normal", basePower: 40, category: "Physical", accuracy: 100, description: "" },
      ],
      canTera: false,
      switches: [],
  ...
  it("scores defog when own hazards are up", async () => {
    ...
    const actions: BattleActionSet = {
      moves: [
        { name: "Defog", id: "defog", pp: 16, maxPp: 16, type: "Flying", disabled: false, target: "normal", basePower: 0, category: "Status", accuracy: true, description: "" },
        { name: "Tackle", id: "tackle", pp: 35, maxPp: 35, type: "Normal", disabled: false, target: "normal", basePower: 40, category: "Physical", accuracy: 100, description: "" },
      ],
      canTera: false,
      switches: [],
  ...
  it("does not score setup moves when HP is low", async () => {
    ...
    const actions: BattleActionSet = {
      moves: [
        { name: "Swords Dance", id: "swordsdance", pp: 20, maxPp: 20, type: "Normal", disabled: false, target: "self", basePower: 0, category: "Status", accuracy: true, description: "" },
        { name: "Earthquake", id: "earthquake", pp: 10, maxPp: 10, type: "Ground", disabled: false, target: "normal", basePower: 100, category: "Physical", accuracy: 100, description: "" },
      ],
      canTera: false,
      switches: [],
      forceSwitch: false,
  ...
  it("force switch when all switches are fainted returns first index", async () => {
    ...
    const actions: BattleActionSet = {
      ...
      switches: [
        { index: 2, name: "Clefable", speciesId: "clefable", hp: 0, maxHp: 394, status: "", fainted: true },
        { index: 3, name: "Weavile", speciesId: "weavile", hp: 0, maxHp: 281, status: "", fainted: true },
      ],
      forceSwitch: true,
    };
    const result = await ai.chooseAction(state, actions);
  ...
  it("force switch picks healthiest when no opponent active info", async () => {
    ...
    const actions: BattleActionSet = {
      ...
      canTera: false,
      switches: [
        { index: 2, name: "Clefable", speciesId: "clefable", hp: 200, maxHp: 394, status: "", fainted: false },
        { index: 3, name: "Weavile", speciesId: "weavile", hp: 281, maxHp: 281, status: "", fainted: false },
      ],
      forceSwitch: true,
    };
  ...
  it("considers switches when in a bad type matchup (lines 62-76)", async () => {
    ...
    const actions: BattleActionSet = {
      moves: [
        { name: "Ice Shard", id: "iceshard", pp: 30, maxPp: 30, type: "Ice", disabled: false, target: "normal", basePower: 40, category: "Physical", accuracy: 100, description: "Priority." },
        { name: "Knock Off", id: "knockoff", pp: 32, maxPp: 32, type: "Dark", disabled: false, target: "normal", basePower: 65, category: "Physical", accuracy: 100, description: "" },
      ],
      canTera: false,
      switches: [
        { index: 2, name: "Toxapex", speciesId: "toxapex", hp: 304, maxHp: 304, status: "", fainted: false },
      ],
      forceSwitch: false,
    };
  ...
  it("scores priority moves with low opp HP (line 145-157)", async () => {
    ...
    const actions: BattleActionSet = {
      moves: [
        { name: "Aqua Jet", id: "aquajet", pp: 20, maxPp: 20, type: "Water", disabled: false, target: "normal", basePower: 40, category: "Physical", accuracy: 100, description: "Priority." },
        { name: "Tackle", id: "tackle", pp: 35, maxPp: 35, type: "Normal", disabled: false, target: "normal", basePower: 40, category: "Physical", accuracy: 100, description: "" },
      ],
      canTera: false,
      switches: [],
  ...
  it("scores various hazard moves (spikes, toxicspikes, stickyweb)", async () => {
    ...
    const actions: BattleActionSet = {
      moves: [
        { name: "Spikes", id: "spikes", pp: 20, maxPp: 20, type: "Ground", disabled: false, target: "foeSide", basePower: 0, category: "Status", accuracy: true, description: "" },
        { name: "Toxic Spikes", id: "toxicspikes", pp: 20, maxPp: 20, type: "Poison", disabled: false, target: "foeSide", basePower: 0, category: "Status", accuracy: true, description: "" },
        { name: "Sticky Web", id: "stickyweb", pp: 20, maxPp: 20, type: "Bug", disabled: false, target: "foeSide", basePower: 0, category: "Status", accuracy: true, description: "" },
      ],
      canTera: false,
      switches: [],
      forceSwitch: false,
  ...
  it("scores status infliction moves (all types)", async () => {
    ...
    const actions: BattleActionSet = {
      moves: [
        { name: "Will-O-Wisp", id: "willowisp", pp: 16, maxPp: 16, type: "Fire", disabled: false, target: "normal", basePower: 0, category: "Status", accuracy: 85, description: "" },
        { name: "Thunder Wave", id: "thunderwave", pp: 20, maxPp: 20, type: "Electric", disabled: false, target: "normal", basePower: 0, category: "Status", accuracy: 90, description: "" },
        { name: "Yawn", id: "yawn", pp: 16, maxPp: 16, type: "Normal", disabled: false, target: "normal", basePower: 0, category: "Status", accuracy: true, description: "" },
      ],
      canTera: false,
      switches: [],
      forceSwitch: false,
  ...
  it("scores defog when own hazards are up", async () => {
    ...
    const actions: BattleActionSet = {
      moves: [
        { name: "Rapid Spin", id: "rapidspin", pp: 40, maxPp: 40, type: "Normal", disabled: false, target: "normal", basePower: 50, category: "Physical", accuracy: 100, description: "" },
      ],
      canTera: false,
      switches: [],
      forceSwitch: false,
  ...
  it("default status move score for unknown status moves", async () => {
    ...
    const actions: BattleActionSet = {
      moves: [
        { name: "Trick Room", id: "trickroom", pp: 8, maxPp: 8, type: "Psychic", disabled: false, target: "all", basePower: 0, category: "Status", accuracy: true, description: "" },
      ],
      canTera: false,
      switches: [],
      forceSwitch: false,
  ...
  it("handles unknown move data in scoreMove (line 103)", async () => {
    ...
    const actions: BattleActionSet = {
      moves: [
        { name: "FakeMove123", id: "fakemove123", pp: 10, maxPp: 10, type: "Normal", disabled: false, target: "normal", basePower: 100, category: "Physical", accuracy: 100, description: "" },
      ],
      canTera: false,
      switches: [],
      forceSwitch: false,

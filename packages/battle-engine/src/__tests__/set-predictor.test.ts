...
import { SetPredictor } from "../ai/set-predictor";
...
describe("SetPredictor", () => {
  ...
  describe("initialize", () => {
    ...
    it("handles multiple pokemon IDs", async () => {
      ...
      const heatranSets = [
        ...
        makeSet({ name: "Heatran B", pokemonId: "heatran", ability: "Flash Fire", item: "Leftovers" }),
      ];
  ...
  describe("updateFromObservation", () => {
    it("reduces probability for sets not containing observed move", () => {
      const sets = [
        makeSet({ name: "With EQ", moves: ["Earthquake", "Outrage", "Swords Dance", "Stealth Rock"] }),
        makeSet({ name: "No EQ", moves: ["Dragon Claw", "Fire Fang", "Swords Dance", "Stealth Rock"] }),
      ];
      predictor.initializeFromSets("garchomp", sets);
    ...
    it("handles case-insensitive move matching", () => {
      const sets = [
        makeSet({ name: "WithEQ", moves: ["earthquake", "Outrage", "Swords Dance", "Stealth Rock"] }),
      ];
      predictor.initializeFromSets("garchomp", sets);
